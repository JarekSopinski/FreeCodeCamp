...
When the count is positive, the player should bet high. When the count is zero or negative,
...
if the count is positive, or "Hold" if the count is zero or negative. The current count and
